    ...
    RouteLocator gatewayProjectServiceRouters(RouteLocatorBuilder builder){
        return builder.routes()
                ...
                .route(r -> r.path("/project/delete/*").and().method("DELETE")
                    ...
                    .uri(projectservice_url))
                .route(r -> r.path("/project/addUserInProject").and().method("GET")
                        .filters(f -> f.rewritePath("/project/addUserInProject","/addUserInProject/project"))
                    .uri(projectservice_url))
                .route(r -> r.path("/project/removeUserFromProject").and().method("GET")
                        .filters(f -> f.rewritePath("/project/removeUserFromProject","/removeUserFromProject/project"))
                        .uri(projectservice_url))
