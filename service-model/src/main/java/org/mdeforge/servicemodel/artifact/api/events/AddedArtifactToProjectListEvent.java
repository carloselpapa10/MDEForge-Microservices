...
public class AddedArtifactToProjectListEvent implements ArtifactDomainEvent{
	...
	public AddedArtifactToProjectListEvent() {}

	public AddedArtifactToProjectListEvent(ArtifactInfo artifactInfo) {
		super();
		this.artifactInfo = artifactInfo;
	}

	public AddedArtifactToProjectListEvent(CommentInfo commentInfo) {
		super();
		this.commentInfo = commentInfo;
	}

	public AddedArtifactToProjectListEvent(MetricInfo metricInfo) {
		super();
		this.metricInfo = metricInfo;
	}

	public AddedArtifactToProjectListEvent(RelationInfo relationInfo) {
		super();
		this.relationInfo = relationInfo;
	}

	public AddedArtifactToProjectListEvent(PropertyInfo propertyInfo) {
		super();
		this.propertyInfo = propertyInfo;
	}

	public AddedArtifactToProjectListEvent(GridFileMediaInfo gridFileMediaInfo) {
		super();
